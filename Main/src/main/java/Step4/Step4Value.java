...
public class Step4Value implements WritableComparable<Step4Value> {
    //Value = {w1, w2,decade,c12,N}
...
//        this.N=new Text();
    ...
    public Step4Value(Text w1, Text w2, Text decade, Text npmi) { //, Text N
        super();
        this.w1 = w1;
        this.w2 = w2;
        this.decade = decade;
...
//        this.N.readFields(in);
    ...
    @Override
    public int compareTo(Step4Value other) { // w1 > decade
