...
public class Step2Value implements WritableComparable<Step2Value> {
...
//        this.N=new Text();
    ...
    public Step2Value(Text w1, Text w2, Text decade, Text c12){//}, Text N) {
        super();
        this.w1 = w1;
        this.w2 = w2;
        this.decade = decade;
...
//    public Text getN() { return this.N; }
    ...
    public Step2Value copy(){return new Step2Value(new Text(this.w1),new Text(this.w2),new Text(this.decade),new Text(this.c12));}//,new Text(this.N));}
...
//
    @Override
    public int compareTo(Step2Value other) { // w1 > decade
...
//        return w2.compareTo(other.w2);
    ...
    public String toString() {
        return this.w1 + " " + this.w2 + " " + this.decade+ " " + this.c12;//+ " " + this.N;
    }
